...
| - [x] | T-062 | Complete Kitty module | `modules/kitty/packages.toml` and any additional static Kitty config files (font size, keybindings) alongside `kitty.conf.tera` | T-056, T-062 | M |
